        ...
        <section class="py-20 px-6 sm:px-12 text-black bg-white">
            <div class="max-w-5xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <div>
                        <img src="{{ URL::to('/images/doka/services/haushaltsaufloesung.webp') }}" alt="Haushaltsauflösung und Entrümplung" class="w-full h-80 object-cover rounded-2xl shadow-lg">
                    </div>
                </div>
