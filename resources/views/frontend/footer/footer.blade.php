<footer class="relative text-white py-16 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto py-10 px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
            ...
            <p class="text-gray-100 text-sm mb-2">
                <span class="font-medium">Bollmann Hausservice</span><br>
                Dahrenhorst 2<br>
                31311 Uetze
            </p>
        </div>
        ...
        <div>
            ...
            <ul class="text-gray-100 text-sm space-y-2">
                <li><a href="tel:+491741933640" class="hover:text-white transition">+49 174 1933640</a></li>
                <li><a href="mailto:kontakt@hausservice-bollmann.de" class="hover:text-white transition">kontakt@hausservice-bollmann.de</a></li>
    ...
    <div class="relative z-10 mt-12 text-center text-gray-200 text-sm pt-6">
        &copy; 2025 Bollmann Hausservice. Alle Rechte vorbehalten.
    </div>
</footer>
